            ...
            >
                ...
                >
                    ...
                    <template v-else-if="editMode">
                        ...
                        <div v-if="hadir === -1">
                            <!-- USER DAPAT MEMILIH DATANG KEMANA -->
                            <p
                                class="my-4 text-sm"
                                v-if="
                                    $parent.$parent.user.diundang_ke ===
                                    'undefined'
                                "
                            ></p>
                            <!-- USER SUDAH DITENTUKAN (diundang_ke !== undefined)  -->
...
<!--
    ...
    Alur konfirmasi
    Undangan ada 2 macam :
        -A- sudah d tentukan ke bwi / malang (diundang_ke bernilai bwi / mlg)
        -B- Dibebaskan memilih (diundang_ke bernilai undefined)

    A
        - konfirmasi kehadiran (ya / tidak), tidak : nilai 0
    B
        - isi hadir_ke
        - konfirmasi kehadiran (ya / tidak), tidak : nilai 0


    default jumlah_hadir = -1
